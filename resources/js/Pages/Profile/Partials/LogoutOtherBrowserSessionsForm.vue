<template>
    <jet-action-section>
        ...
        <template #description>
            Gerencia suas sessões recentes, e desconecte de outros dispositivos.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Você pode deslogar de todas as suas sessões, caso você entenda que a senha da sua conta foi comprometida, assim desconectará de todos os dispositivos.
            </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                <span class="text-green-500 font-semibold" v-if="session.is_current_device">computador atual</span>
